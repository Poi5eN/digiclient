  ...
  return (
    ...
    {/* Right: Profile & Notification */}
      ...
      <div>
         ...
         >
          {isFullScreen ? <MdFullscreenExit className="text-[30px] text-white" title="Fullscreen Exit" /> : <MdFullscreen className="text-[30px] text-white" title="full screen" />}
         </button>
      </div>
              ...
              onClick={() => handleClick("userProfile")}
                >
                   <img
                      ...
                      alt="user-profile"
                  />
                 <p className="text-black-400 text-white font-semibold text-[16px] dark:text-white whitespace-nowrap hidden md:block">
                 {fullName}
                 </p>
