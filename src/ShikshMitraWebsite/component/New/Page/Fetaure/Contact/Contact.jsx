                    ...
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Faridabad , Delhi, Noida,  Haryana</p>
                                <p class="text-gray-600 dark:text-slate-400">Muzaffarnapur(Bihar) , Mothari(Bihar),</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-[#ee582c] text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Mobile: 9873993957,9873998949,9873998919</p>
                                <p class="text-gray-600 dark:text-slate-400">Mail: digitalvidyasaarthi@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-[#ee582c] text-gray-50">
                            ...
                            <div class="ml-4 mb-4">
                                <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Working
                                    hours</h3>
                                <p class="text-gray-600 dark:text-slate-400">Monday - Friday: 09:00 AM - 4:00 PM</p>
                                <p class="text-gray-600 dark:text-slate-400">Saturday &amp; Sunday: 11:00 AM - 4:00 PM</p>
                            </div>
                        </li>
                    </ul>
                </div>
