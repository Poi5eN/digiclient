...
import { adminRoutecreateClass } from "../../../Network/AdminApi";
...
function Primary() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response =await adminRoutecreateClass(formattedFormData)
      if(response?.success){
        setLoading(false);
      ...
      console.log("first class response " ,response)
      // axios
      //   .post(
  ...
  return (
    <div className="md:h-screen mt-12 md:mt-1 mx-auto p-3">
      ...
      {isOpen && (
        ...
        >
          <div className="relative p-4 w-full max-h-full" data-aos="zoom-in">
