...
//   }, [showForm]);
  ...
  return (
    <div className="px-5">
      <Heading2 title={"All EXAMS"}></Heading2>

      <div className=" mx-auto bg-gray-50   ">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="mt-2 grid sm:grid-cols-3  md:grid-cols-3  lg:grid-cols-3 grid-cols-2 gap-3 px-2  mx-auto bg-gray-100 rounded-md ">
            <ReactInput
              type="text"
              //  id="examName"
              name="examName"
