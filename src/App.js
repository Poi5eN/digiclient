...
const Teacher = lazy(() => import("./ShikshMitraWebsite/component/LoginPage/Teacher"));
const Login = lazy(() => import("./ShikshMitraWebsite/component/LoginPage/Login"));
...
const AdditionalFee = lazy(() => import("./ADMINDASHBOARD/Fees/Additional/AdditionalFee"));
const ClasswiseFee = lazy(() => import("./ADMINDASHBOARD/Fees/ClassWise/ClasswiseFee"));
const EditClasswiseFees = lazy(() => import("./ADMINDASHBOARD/Fees/ClassWise/EditClassWise"));
const Allstudent = lazy(() => import("./ADMINDASHBOARD/Student/AllStudent/Allstudent"));
const EditStudent = lazy(() => import("./ADMINDASHBOARD/Student/AllStudent/EditStudent"));
const Promotion = lazy(() => import("./ADMINDASHBOARD/Student/Promotion/Promotion"));
const CreateParents = lazy(() => import("./ADMINDASHBOARD/Parents/AllParent/CreateParents"));
const FeeStatus = lazy(() => import("./ADMINDASHBOARD/Parents/FeesStatus/FeeStatus"));
const Income = lazy(() => import("./ADMINDASHBOARD/Account/Income"));
const Expenditure = lazy(() => import("./ADMINDASHBOARD/Account/Expenditure/Expenditure"));
...
const Registration = lazy(() => import("./ADMINDASHBOARD/Admission/Registration"));
const AdmissionStatus = lazy(() => import("./ADMINDASHBOARD/Admission/AdmissionStatus"));
...
const EditAdmission = lazy(() => import("./ADMINDASHBOARD/Admission/EditAdmission"));
const ViewPrimary = lazy(() => import("./ADMINDASHBOARD/Classes/Primary/ViewPrimary"));
const EditPrimary = lazy(() => import("./ADMINDASHBOARD/Classes/Primary/EditPrimary"));
...
const ViewStudentTeacher = lazy(() => import("./TEACHERDASHBOARD/MyStudent/ViewStudent"));
const EditStudentTeacher = lazy(() => import("./TEACHERDASHBOARD/MyStudent/EditStudent"));
...
const StudentStudyMaterial = lazy(() => import("./STUDENTDASHBOARD/StudentStudyMaterial"));
const TimeTable = lazy(() => import("./STUDENTDASHBOARD/TimeTable"));
const StudentAssigments = lazy(() => import("./STUDENTDASHBOARD/StudentAssigments"));
...
const StudentFeeStatus = lazy(() => import("./ADMINDASHBOARD/Student/AllStudent/StudentFeeStatus"));
...
function App() {
  ...
  useEffect(() => {
    // If token exists but role is missing, redirect to login
    if (token && !userRole) {
      localStorage.clear();
...
<Route path="/" element={<LandingPage />}>
                   ...
                   <Route path="/thirdparty" element={<Navigate to="/" />}/>
