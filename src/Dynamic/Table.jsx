  ...
  return (
    <section className="py-1 bg-blueGray-50 ">
      <div className="relative flex flex-col min-w-0 break-words  w-full mb-6 shadow-lg rounded">
        {
          isSearch && <div className="rounded-t  mt-2 mb-1 border-0">
        ...
        <div className="block w-full overflow-x-auto h-[70vh] overflow-y-auto">
            ...
            <thead className="sticky top-0 z-10">
              ...
              <tr>
                {tHead.map((header) => (
                  ...
                  <th class="px-2 py-1 border-b border-slate-300 bg-slate-50 whitespace-nowrap"
